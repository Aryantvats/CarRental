...
function Navbar1({setShowLogin}) {
  ...
  return (
    ...
    lg:px-16 py-4 text-gray-600 border-b border-borderColor relative transition-all
    ${location.pathname === "/" ? "bg-light" : ""}`}>
        ...
        <Link to='/'>
          ...
          >
              ...
              <div className='hidden lg:flex items-center text-sm gp-2 border border-borderColor px-3 rounded-full max-w-56'>
