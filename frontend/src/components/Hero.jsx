...
const Hero = () => {
    ...
    bg-light text-center'>
            <motion.h1
                ...
                className='text-4xl md:text-5xl font-semibold pt-8'>Luxury cars on Rent</motion.h1>
            <motion.form
          ...
          bg-white shadow-[0px_8px_20px_rgba(0,0,0,0.1)]'>
              ...
              gap-10 min-md:ml-8'>
                  <div className='flex flex-col items-start gap-2'>
                      ...
                      <p className='px-1 text-sm yext-gray-500'> { pickupLocation ? pickupLocation :'Please select Location'}</p>
                  </div>
                  <div className='flex flex-col items-start gap-2'>
